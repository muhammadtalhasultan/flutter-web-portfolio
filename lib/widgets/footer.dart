    ...
    return HoverItem(
      builder: ((isHovered) {
        ...
        return Column(
          ...
          crossAxisAlignment: CrossAxisAlignment.center,
          children: [
            Text(footerText,style: TextStyle(color: hoverColor),textAlign: TextAlign.center,),
            SizedBox(height: 8,),
            Row(
              mainAxisAlignment: MainAxisAlignment.center,
              crossAxisAlignment: CrossAxisAlignment.center,
              children: [
                Icon(Icons.star_border_outlined,size: 14,color: hoverColor,),
                SizedBox(width: 8,),
                Text(footerStarNumber,style: TextStyle(color: hoverColor,fontSize: 12)),
                SizedBox(width: 16,),
                Icon(Icons.share,size: 14,color: hoverColor,),
                SizedBox(width: 8,),
                Text(footerShareNumber,style: TextStyle(color: hoverColor,fontSize: 12)),
              ],
            ),

            SizedBox(height: 30,),  //to give some space
