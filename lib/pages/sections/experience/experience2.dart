    ...
    return Column(
      ...
      children: [
        ...
        RichText(
          text: TextSpan(
              children: [
                TextSpan(text: experience2_title,style: TextStyle(color: title_color,fontSize: isDesktop(context)?26:18,fontWeight: FontWeight.w700),),
                TextSpan(text: experience2_title_linl,style: TextStyle(color: linkColor,fontSize: isDesktop(context)?26:18,fontWeight: FontWeight.w700),recognizer: TapGestureRecognizer()..onTap=launchExperienceSite),
              ]
          ),
        ),
        SizedBox(height: 8,),
        Text(experience2_duration,style: TextStyle(color: desColor),),
        SizedBox(height: 16,),
        buildDescription(experience2_des1),
        SizedBox(height: 16,),
        buildDescription(experience2_des2),
        SizedBox(height: 16,),
        buildDescription(experience2_des3),
        SizedBox(height: 16,),
      ],
    );
  }
