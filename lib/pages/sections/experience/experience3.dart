...
class Experience3 extends StatelessWidget {
  Experience3({Key? key}) : super(key: key);
    ...
    return Column(
      ...
      children: [
        ...
        RichText(
          text: TextSpan(
              children: [
                TextSpan(text: experience3_title,style: TextStyle(color: title_color,fontSize: isDesktop(context)?26:18,fontWeight: FontWeight.w700),),
                TextSpan(text: experience3_title_linl,style: TextStyle(color: linkColor,fontSize: isDesktop(context)?26:18,fontWeight: FontWeight.w700),recognizer: TapGestureRecognizer()..onTap=launchExperienceSite),
              ]
          ),
        ),
        SizedBox(height: 8,),
        Text(experience3_duration,style: TextStyle(color: desColor),),
        SizedBox(height: 16,),
