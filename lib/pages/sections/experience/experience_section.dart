...
class _ExperienceSectionState extends State<ExperienceSection> {
  ...
  List<Tab> tabs = [
    Tab(
      child: Text(
        experience_list[0],
        style: TextStyle(color: light_index_color),
      ),
    ),
    Tab(
      child: Text(
  ...
  Widget build(BuildContext context) {
    ...
    desColor = themeProvider.isDarkMode
        ? salate_color
        : light_navy_color; //description color
          ...
          ? Row(
              children: [
                ...
                Expanded(
                    flex: 5,
                    child:
                        experience()), //in desktop mode I want to show experience in the middle
                Expanded(flex: 1, child: Center()),
              ],
            )
          : experience(),
      ...
      child: Container(
          ...
          child: Align(
              ...
              child: Padding(
                ...
                child: Text(
                  experience_list[index_],
                  style: TextStyle(color: txt_color, fontSize: font_size),
                ),
              ))),
    );
  }
