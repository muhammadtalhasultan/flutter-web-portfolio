...
class _ArchiveSectionState extends State<ArchiveSection> {
        ...
        children: [
          ...
          Expanded(
            child: isMobile(context)
                ? createArchiveList(context)
                : Row(
                    children: [
                      Expanded(
                          flex: 1, child: ShowAnimation(child: SectionLeft())),
                      Expanded(flex: 5, child: createArchiveList(context)),
                      Expanded(
                          flex: 1, child: ShowAnimation(child: SectionRight())),
                    ],
                  ),
          ),
        ],
  ...
  Widget archiveList_header(BuildContext context) {
    final textStyle =
        TextStyle(fontSize: 18, fontWeight: FontWeight.w700, color: desColor);
              ...
              children: [
                ...
                Expanded(
                    ...
                    child: HoverItem(builder: (isHovered) {
                      final iconColor =
                          isHovered ? index_color : hoberIconColor;
                      return GestureDetector(
                        onTap: () => launchUrl(archive.link),
                        child: FaIcon(
                          FontAwesomeIcons.externalLinkAlt,
